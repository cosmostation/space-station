...
function createDelegateMessage (delegator: string, validator: string, amount: number) {
...
function createWithdrawDelegatorRewardMessage (delegator: string, validator: string) {
